...
import talismanIcon from "../../public/images/walleticon.png"; // Update the path to the Talisman icon
import { toast } from "sonner";
import { usePolkaContext } from "@/app/providers";
...
const WalletConnection = () => {
  ...
  return (
    <div className="relative">
      <button
        className={`rounded-full py-2 px-4 text-center text-base font-manrope ${connected ? "bg-[#4e7fff] text-green-0" : "bg-blue-500 text-white"
          }`}
